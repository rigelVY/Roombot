/*
Reference : ROS講座24 RvisにVisualizationMarkerを表示する(https://qiita.com/srs/items/3d16bf8cc60a364bd783)
*/
...
int main(int argc, char **argv){
  ros::init(argc, argv, "twist_marker_visualizer");
  ros::NodeHandle n;

  //publisher
  ros::Publisher marker_pub   = n.advertise<visualization_msgs::MarkerArray>("cmd_vel_marker_array", 1);
